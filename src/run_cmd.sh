...
./tgcat-tester language data/external/r-2/dc0428-input/original/dc0428-input-all.txt data/processed/dc0428-language_output.txt
./tgcat-tester category data/external/r-2/dc0428-input/original/dc0428-input-all.txt data/processed/dc0428-category_output.txt